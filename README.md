...
| 24.02.12 | 4 | 섹션 4: 리액트 핵심 - 심화 단계 | 1) 엄세원 <br/> - 사용자 입력 & 양방향 바인딩 ~ 교차 State(상태) 방지하기 <br/> 2) <br/> - <br/> 3) 조용운 <br/> -계산된 값 처리~마무리  |
| 24.02.18 | 5 | 섹션 5: 리액트 핵심 - 연습 프로젝트 <br/> 섹션 6: 리액트 컴포넌트 스타일링 | 1) <br/> - <br/> 2) 조용운 <br/> -State 끌어올리기 ~ 조건적 컨텐츠 출력 <br/> 3) 엄세원 <br/> - 모듈 소개 & 프로젝트 시작하기 ~ 동적 및 조건적 Inline(인라인) 스타일 |
